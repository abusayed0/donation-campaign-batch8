...
import addDonationIdInLS from "../../utilities/local-storage";
...
const DonationDetails = () => {
    ...
    const { textColorAndButtonBg } = colors;
    const handleDonate = () => {
        ...
        <div className="max-w-[1320px] px-2 md:px-6 box-content mx-auto mt-20">
            <div className="relative">
                ...
                <div className="bg-[rgba(11,11,11,0.50)] rounded-br-lg rounded-bl-lg absolute w-full bottom-0 p-4 md:p-7">
                    <button onClick={handleDonate} className="font-bold text-xl text-white px-4 md:px-6 py-2 md:py-4 rounded" style={{ backgroundColor: textColorAndButtonBg }}>Donate ${donationAmount}</button>
                    <Toaster
